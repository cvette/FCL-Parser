...
function UndefinedException(line, column, symbol) {
    this.message = 'Symbol "' + symbol + '" is undefined';
...
function declareSymbol(line, column, symbol, typeNode, scope) {
    ...
    console.log("[" + line + ":" + column + "] Declaration: " + symbol + " of type: " + type);
...
function useSymbol(line, column, symbol, scope) {
    ...
    console.log("[" + line + ":" + column + "] Usage: " + symbol + " in scope " + scope);
    if (symbols[scope][symbol] === undefined) {
        throw new UndefinedException(line, column, symbol);
    }
}
