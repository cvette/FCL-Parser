...
var NodeTypes = {
    ...
    STRUCTURED_VARIABLE:            "StructuredVariable",
    WEIGHTING_FACTOR:               "WeightingFactor",
    DATA_TYPE_DECLARATIONS:         "DataTypeDeclarations",
    DATA_TYPE_DECLARATION:          "DataTypeDeclaration",
    STRUCTURE_DECLARATION:          "StructureDeclaration",
    STRUCTURE_ELEMENT_DECLARATION:  "StructureElementDeclaration"
};
...
exports.DataTypeDeclarations = function (line, column, properties, children) {
    this.type = NodeTypes.DATA_TYPE_DECLARATIONS;
    AstNode.call(this, line, column, properties, children);
};
...
exports.DataTypeDeclaration = function (line, column, properties, children) {
    this.type = NodeTypes.DATA_TYPE_DECLARATION;
    AstNode.call(this, line, column, properties, children);
};
...
/** DataTypeDeclaration */
exports.StructuredVariable = function (line, column, properties, children) {
    this.type = NodeTypes.STRUCTURED_VARIABLE;
    AstNode.call(this, line, column, properties, children);
};

exports.StructuredVariable.prototype = Object.create(AstNode.prototype);

/** StructureDeclaration */
exports.StructureDeclaration = function (line, column, properties, children) {
    this.type = NodeTypes.STRUCTURE_DECLARATION;
    AstNode.call(this, line, column, properties, children);
};

exports.StructureDeclaration.prototype = Object.create(AstNode.prototype);

/** StructureDeclaration */
exports.StructureElementDeclaration = function (line, column, properties, children) {
    this.type = NodeTypes.STRUCTURE_ELEMENT_DECLARATION;
    AstNode.call(this, line, column, properties, children);
};

exports.StructureElementDeclaration.prototype = Object.create(AstNode.prototype);