...
/** Function Block */
exports.FunctionBlock = function (line, column, name, inputVars, outputVars, otherVars, fuzzifyBlocks, defuzzifyBlocks, ruleBlocks, optionsBlocks) {
    AstNode.call(this, line, column);
    this._name = name;
    this._inputVars = inputVars;
    this._outputVars = outputVars;
    this._otherVars = otherVars;
    this._fuzzifyBlocks = fuzzifyBlocks;
    this._defuzzifyBlocks = defuzzifyBlocks;
    this._ruleBlocks = ruleBlocks;
    this._optionsBlocks = optionsBlocks;

    this.toString = function() {
        return "FunctionBlock " + this._name + ": " + this._inputVars + ", " + this._outputVars + ", " + this._otherVars + ", " + this._fuzzifyBlocks + ", " + this._defuzzifyBlocks + ", " + this._ruleBlocks + ", " + this._optionsBlocks;
    };
};
...
/** Term */
exports.Term = function(line, column, name, func) {
    AstNode.call(this, line, column);
    this._name = name;
    this._function = func;
